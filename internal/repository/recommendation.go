...
type RecommendationRepository interface {
	...
	ListBySkinType(ctx context.Context, skinType domain.SkinType, offset int, limit int) ([]*models.Recommendation, int64, error)
	List(ctx context.Context, offset int, limit int) ([]*models.Recommendation, int64, error)
